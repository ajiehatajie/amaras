...
<div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::text('npwp', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('npwp', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('direktur') ? 'has-error' : ''}}">
    {!! Form::label('direktur', 'Direktur', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('direktur', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('direktur', '<p class="help-block">:message</p>') !!}
    </div>
